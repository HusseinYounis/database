...
::: callout-tip
Drag the slider to change the number of rows. Observe how a full file scan grows linearly ($O(n)$) while a B+ tree index lookup grows only logarithmically ($O(\log n)$).
:::
...
> *This section contains an interactive visualization. View the online HTML version to explore file-scan vs. index-lookup costs across different table sizes.*
:::
...
::: {.content-visible when-format="epub"}
> *This section contains an interactive B+ tree explorer. View the online HTML version to see how tree order and record count affect height and fan-out.*
:::
