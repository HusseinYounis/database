...
### 8.1.1 Single CTE — Readable Subquery
...
### 8.1.2 Multiple CTEs — Chained Steps
...
### 8.2.2 Analytic / Offset Functions
...
### 8.2.4 Frame Specification (ROWS vs RANGE)
...
### 8.2.5 Window Functions vs GROUP BY
...
### 8.3.1 Creating and Querying Views
...
### 8.3.2 Updatable vs Non-Updatable Views
...
### 8.4.3 Procedures vs Functions vs Triggers
...
### 8.5.3 Validation Trigger — Rejecting Bad Data
...
## 8.3 Common Table Expressions (CTE)
...
## 8.6 Stored Procedures and Functions
