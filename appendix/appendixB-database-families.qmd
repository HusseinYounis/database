...
![Graph database — data is modelled as *nodes* connected by typed *edges* (relationships), each carrying its own properties. *(Source: OpenXcell)*](../images/graph-database.png){#fig-graph-database width=70% fig-align="center"}
...
## 8. NewSQL & Cloud-Native Distributed SQL ☁️
