...
## 1.4 Database Schema vs. Instance
...
## 1.8 DBMS Deployment Architecture
...
%%| echo: false
flowchart LR
    T1["1-Tier<br/>User + App + DB<br/>on one machine"]
    T2["2-Tier<br/>Client ↔ DB Server"]
    T3["3-Tier<br/>Client ↔ App Server ↔ DB Server"]
    T1 -.->|"add DB server"| T2
    T2 -.->|"add app layer"| T3
```
...
## 1.9 Advantages of Using a DBMS
